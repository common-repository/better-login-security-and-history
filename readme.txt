...
Contributors: tieuthutrieugia
Donate link: http://tieuthutrieugia.net/donations/
Tags: Login,Security,History,Captcha
...
== Description ==
Login with captcha.
Protect your login page from Brute-force attacks also you can track login history.
Features:<ul>
...
<li>Go to the tab "Upload" and choose the file "better-login-security-and-history.zip", click the button "Upload" to get the file uploaded.</li>
